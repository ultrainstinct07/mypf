---
title: "Aircrack-ng"
description: "Aircrack-ng tool guide; includes tool's purpose,primary uses,core features,data sources, common commands and example of command's usages."
tags: ['network', 'wi-fi']
---
...
Capture Packets| `airodump-ng wlan0`| Captures packets on wlan0 interface.| `CH 9 ][ Elapsed: 10 s ][ 2024-08-07 18:25 ] `   
...
Crack WPA/WPA2-PSK Key| `aircrack-ng -w rockyou.txt -b AA:BB:CC:DD:EE:FF capture.cap`| Cracks WPA/WPA2-PSK key using wordlist.| `Passphrase not in dictionary `   
` Read 100000 packets...`  
